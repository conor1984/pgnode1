...
CMD ["/usr/lib/postgresql/9.4/bin/pg_ctl", "-D", "/var/lib/postgresql/9.4/main", "-c", "config_file=/etc/postgresql/9.4/main/postgresql.conf" , "-l", "/var/log/postgresql/logg.log", "start"]
