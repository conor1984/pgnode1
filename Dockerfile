...
RUN	 #cp /home/maximus/postgresql.conf /home/maximus/cluster/data/postgresql.conf &&\
	 #sed -i 's/var\/run/home\/maximus\/socketsandstats/g' /home/maximus/cluster/data/postgresql.conf &&\
