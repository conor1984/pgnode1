...
EXPOSE 5432  6432  22
CMD ["/usr/lib/postgresql/9.4/bin/postgres", "-l", "/var/log/postgresql/post.log", "-D", "/var/lib/postgresql/9.4/main", "-c", "config_file=/etc/postgresql/9.4/main/postgresql.conf"]
